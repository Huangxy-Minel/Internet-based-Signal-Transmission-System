...
#define ENABLE(n) 		(n?HAL_GPIO_WritePin(GPIOF,GPIO_PIN_0,GPIO_PIN_SET):HAL_GPIO_WritePin(GPIOF,GPIO_PIN_0,GPIO_PIN_RESET))
#define SCLK(n) 		(n?HAL_GPIO_WritePin(GPIOG,GPIO_PIN_1,GPIO_PIN_SET):HAL_GPIO_WritePin(GPIOG,GPIO_PIN_1,GPIO_PIN_RESET))
