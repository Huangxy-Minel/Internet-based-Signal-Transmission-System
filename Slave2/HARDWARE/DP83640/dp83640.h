...
/*
	¹ØÓÚPTP Event Triggering£¨ÊÂ¼ş´¥·¢£¬µçÆ½Êä³ö£©£º
			1.event triggerÊÇÖ¸ÔÚÄ³¸öÊ±¼äÖµÉÏÔÚÄ³¸öGPIOÉÏÊä³öÒ»¸ö´¥·¢ĞÅºÅ
			2.¿ÉÔÚ1¸öGPIOÉÏ¸´ÓÃ¶à¸ötriggerÔ´
			3.ÔÚPTP Trigger Configuration RegisterÀïÅäÖÃ³ö·¢Ô´
				ÔÚPTP control£¬Time Data RegisterÀïÅäÖÃ´¥·¢Ê±¼ä³¤¶ÈºÍ¿í¶È
			4.¿ÉÒÔ±»±à³ÌÎª Pulse Per SecondµÄ´¥·¢ĞÎÊ½
			
	¹ØÓÚPTP Event Timestamp£¨ÊÂ¼şÊ±¼ä´Á£¬µçÆ½ÊäÈë£©:
			1.event timestampÊÇÖ¸¶ÔÄ³¸öÊäÈëĞÅºÅ½øĞĞÊ±¼ä´Á²É¼¯
			2.ÊäÈëĞÅºÅ¿ÉÒÔÊÇÉÏÉıÑØ¡¢ÏÂ½µÑØµÈĞÎÊ½
*/
...
#define DP83640_PTP_TXCFG0_TX_TS_EN     ((uint16_t)0x0020U)//Ê¹ÄÜ·¢ËÍ±¨ÎÄµÄÊ±¼ä´Á×¥È¡(³õÊ¼»¯Ê¹ÄÜ)
...
#define DP83640_PTP_RXCFG0_RX_TS_EN     ((uint16_t)0x0020U)//Ê¹ÄÜ½ÓÊÕ±¨ÎÄµÄÊ±¼ä´Á×¥È¡(³õÊ¼»¯Ê¹ÄÜ)
...
void DP83640_EnableIT(u32 interrupt);
void DP83640_DisableIT(u32 interrupt);
void DP83640_ClearIT(u32 interrupt);
u8 DP83640_GetITStatus(u32 interrupt);
